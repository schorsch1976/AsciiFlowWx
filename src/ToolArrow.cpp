...
void ToolArrow::OnMousePressed(wxPoint point) { m_start = point; }
void ToolArrow::OnMouseMove(wxRect /* area */, wxPoint point)
{
...
void ToolArrow::OnMouseReleased(wxPoint /* point */) {}

void ToolArrow::OnKeyPressed(wxKeyEvent /* c */) {}

wxVector<wxRect> ToolArrow::MarkedAreas() { return wxVector<wxRect>(); }
